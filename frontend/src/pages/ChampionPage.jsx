...
/**
 * «Кубок» — у всех ролей (canViewChampionBoard / CAN_VIEW_CHAMPION_BOARD).
 * Смотрят доску все, а соревнуются только менеджеры и топ-менеджеры: состав
 * участников задаёт COMPETING_ROLES на сервере, к доступу он отношения не
 * имеет.
 *
  ...
  return (
    <div className="max-w-[880px] mx-auto px-8 pt-12 pb-20 flex flex-col gap-6">
      ...
      <PageHeader title="Кубок" spaced={false}>
        Обладатель кубка предыдущего месяца и рейтинг текущего. Новый победитель определяется
