  ...
  return (
    <div className="max-w-[980px] mx-auto px-8 pt-12 pb-20">
      <PageHeader title="Шаблоны">
        Папки с шаблонами документов. Можно генерировать напрямую из шаблонов, но данные контрагента из карточки подставить не получится
      </PageHeader>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2.5 flex-shrink-0">
                  {/* "Скрыт" приходит только привилегированным ролям — менеджеру
                      скрытый шаблон в списке вообще не отдаётся (см. browse_folder).
                      Значит эта пометка видна лишь тем, кто вправе её видеть. */}
                  {tpl.hidden_for_managers && <Badge variant="neutral">скрыт</Badge>}
