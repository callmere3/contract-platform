  ...
  return (
    <div className="max-w-[980px] mx-auto px-8 pt-12 pb-20">
      ...
      <div className="text-[11px] text-text-muted mt-4 leading-snug">
        Баланс — это поступления минус расходы по контрагенту. Минус здесь не ошибка: так
        выглядит выплаченный аванс, который ещё не отработан. Карточки контрагентов заводят
        и правят в ML Docs — это одна и та же база.
      </div>
    </div>
  );
}
