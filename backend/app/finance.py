...
#
# Список общий для поступлений и расходов, а не два разных: «аванс» бывает и
# тем, и другим (выплатили артисту / вернули нам), и раздвоение справочника
# сразу порождает вопрос, в какой половине искать.
FINANCE_CATEGORIES = (
    ("advance", "Аванс"),
    ("royalty", "Роялти"),
    ("services", "Услуги"),
...
CATEGORY_CODES = tuple(code for code, _label in FINANCE_CATEGORIES)
CATEGORY_LABELS = dict(FINANCE_CATEGORIES)
