"""
Вкладка «Кубок» (все роли, CAN_VIEW_CHAMPION_BOARD).
...
СМОТРЯТ доску все, а УЧАСТВУЮТ в ней только менеджеры и топ-менеджеры
(COMPETING_ROLES) — это разные вещи, и открытие вкладки состав участников не
меняло. Чисел в ответе хватает на рейтинг, но страница их не печатает: видно
