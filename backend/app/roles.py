...
# Вкладка «Кубок»: кто носит кубок месяца и рейтинг текущего месяца. Только
# Admin — это сводка по работе всех сотрудников сразу, то же основание, что у
# журнала действий и вкладки «Пользователи». Сам значок кубка при этом видят
# все у себя в шапке: свой результат — не чужая статистика.
CAN_VIEW_CHAMPION_BOARD = (ADMIN,)
