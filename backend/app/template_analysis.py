...
FIELD_META = {
    ...
    "director_name": ("Контрагент", "Ген. директор компании",
                      "полное ФИО или сокращение — в документе будет «Фамилия И. О.»"),
    ...
    "edo_mail":   ("Контакты", "E-mail для ЭДО", "если отличается от основного"),
    ...
    "vat":        ("Документ", "Ставка НДС",
                   "0% — Лицензиар освобождён от НДС (в договоре: «освобожден от уплаты НДС»), иначе печатается ставка прописью"),
