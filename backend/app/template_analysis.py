...
FIELD_META = {
    ...
    "c_date":     ("Документ", "Дата договора",
                   "из неё автоматически собирается номер договора"),
...
#
# Заметь: полей contract_day/month/year здесь НЕТ. Раньше они были,
# но дублировали дату договора — оператор вводил одно и то же дважды.
# Теперь день/месяц/год выводятся из c_date автоматически (см. parse_date).
VIRTUAL_FIELDS = [
