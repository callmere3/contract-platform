...
DEMO_VALUES = {
    ...
    # Документ. Флаги ставим в True осознанно: так демо-заполнение
    # разворачивает и необязательные блоки (SMM, ЭДО) — тестировать имеет
    # смысл документ целиком, а не его усечённый вариант.
    "appendix_no":   "2",
    "act_no":        "2",
    "edo":           True,
    "royalty":       "70",
