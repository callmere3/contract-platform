...
# типов под выбранную страну: для КЗ предлагается ТОО, а не ООО, и наоборот.
...
# подбор документов идёт по точной тройке тегов, и КЗ+ООО не найдёт КЗ+ТОО.
COMPANY_TYPE_BY_COUNTRY = {"РУ": "ООО", "КЗ": "ТОО"}
...
REQUISITE_FIELDS_BY_TYPE = {
    ...
    # ТОО (КЗ): банковские реквизиты РК отличаются, шаблонов пока нет —
