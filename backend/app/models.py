...
class PartnerPayment(Base):
    ...
    # НДС — СТАВКА (коэффициент), а не сумма: в этой таблице он стоит рядом с
    # курсом и работает так же — это множитель, а не деньги. Поэтому и тип
    # тот же, что у курса, и складывать его в итогах нечего.
